...
class TestReadDisturbModel(unittest.TestCase):
    ...
    def test_lrs_change(self):
        ...
        acs_int.set_config(
            os.path.abspath(
                f"{repo_path}/cpp/test/lib/configs/analog/READ_DISTURB_MITIGATION_HW.json"))
        ...
        num_reads = int(round(t / rd_gm.t_read))
        ...
        assert acs_int.cycles_m()[0][0] > acs_int.cycles_p()[0][0]
        assert acs_int.consecutive_reads_m()[0][0] < acs_int.consecutive_reads_p()[0][0]
