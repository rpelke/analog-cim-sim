...
class TestAnalogMapping(unittest.TestCase):
    ...
    def test_analog_I_DIFF_W_DIFF_1XB(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/I_DIFF_W_DIFF_1XB.json"))
    ...
    def test_analog_I_DIFF_W_DIFF_2XB(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/I_DIFF_W_DIFF_2XB.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
        np.testing.assert_array_equal(res, np.array([-13759, -119, -1386], dtype=np.int32))
    ...
    def test_analog_I_OFFS_W_DIFF(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/I_OFFS_W_DIFF.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
        np.testing.assert_array_equal(res, np.array([-13759, -119, -1386], dtype=np.int32))
    ...
    def test_analog_I_TC_W_DIFF(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/I_TC_W_DIFF.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
        np.testing.assert_array_equal(res, np.array([-13759, -119, -1386], dtype=np.int32))
    ...
    def test_analog_I_UINT_W_DIFF(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/I_UINT_W_DIFF.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
    ...
    def test_analog_I_UINT_W_OFFS(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/I_UINT_W_OFFS.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
        np.testing.assert_array_equal(res, np.array([10241, 121, -1386], dtype=np.int32))
    ...
    def test_bnn_i(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/BNN_I.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
    ...
    def test_bnn_ii(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/BNN_II.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
        np.testing.assert_array_equal(res, np.array([2, -2, 0], dtype=np.int32))
    ...
    def test_bnn_iii(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/BNN_III.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
        np.testing.assert_array_equal(res, np.array([2, -2, 0], dtype=np.int32))
    ...
    def test_bnn_iv(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/BNN_IV.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
        np.testing.assert_array_equal(res, np.array([2, -2, 0], dtype=np.int32))
    ...
    def test_bnn_v(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/BNN_V.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
        np.testing.assert_array_equal(res, np.array([2, -2, 0], dtype=np.int32))
    ...
    def test_bnn_vi(self):
        ...
        acs_int.set_config(os.path.abspath("cpp/test/lib/configs/analog/BNN_VI.json"))
        acs_int.cpy(mat, m_matrix, n_matrix)
        acs_int.mvm(res, vec, mat, m_matrix, n_matrix)
        np.testing.assert_array_equal(res, np.array([2, -2, 0], dtype=np.int32))
