...
TEST(INTLibTests, I_DIFF_W_DIFF_1XB) {
    set_cfg_file_env("m_mode_tests/I_DIFF_W_DIFF_1XB.json");
...
TEST(INTLibTests, I_DIFF_W_DIFF_2XB) {
    set_cfg_file_env("m_mode_tests/I_DIFF_W_DIFF_2XB.json");
...
TEST(INTLibTests, I_OFFS_W_DIFF) {
    set_cfg_file_env("m_mode_tests/I_OFFS_W_DIFF.json");
...
TEST(INTLibTests, I_TC_W_DIFF) {
    set_cfg_file_env("m_mode_tests/I_TC_W_DIFF.json");
...
TEST(INTLibTests, I_UINT_W_DIFF) {
    set_cfg_file_env("m_mode_tests/I_UINT_W_DIFF.json");
...
TEST(INTLibTests, I_UINT_W_OFFS) {
    set_cfg_file_env("m_mode_tests/I_UINT_W_OFFS.json");
