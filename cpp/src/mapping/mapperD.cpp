...
MapperD::MapperD() : Mapper(true) {}

MapperD::~MapperD() {}

void MapperD::d_write(const int32_t *mat, int32_t m_matrix, int32_t n_matrix) {
    d_write_diff(mat, m_matrix, n_matrix);
}

void MapperD::a_write(int32_t m_matrix, int32_t n_matrix) {
    a_write_p_m(m_matrix, n_matrix);
}

void MapperD::d_mvm(int32_t *res, const int32_t *vec, const int32_t *mat,
...
void MapperD::a_mvm(int32_t *res, const int32_t *vec, const int32_t *mat,
                    int32_t m_matrix, int32_t n_matrix) {
    // The splitted matrix is of size CFG.SPLITsize*M x N (CFG.SPLITsize values
